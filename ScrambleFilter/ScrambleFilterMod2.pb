...
; RotateImageSimple_BF(-90, image_ID, 255)
;rotate - as above 
;contrast
;brightness
;intensity - ?sat
...
Declare COLORISE()      : Declare FLIP() : Declare PIXELATE1(image, value):;Three new;}
...
Enumeration
   ...
   #Menu_Item_Save   : #Menu_Item_Colorise: #Menu_Item_Flip     : #Menu_Item_Pixelate :
   ...
   If OpenWindow(#WinMain, 0, 0, WinWidth, WinWidth*AspectRatio, title$, flags)
      ...
      If CreateMenu(#Menu,WindowID(#WinMain))
         ...
         MenuTitle("Image")
            ...
            MenuBar()
            MenuItem(#Menu_Item_Colorise, "XColorise")
            ...
            MenuItem(#Menu_Item_Flip      , "Flip")
            MenuBar()
            MenuItem(#Menu_Item_Resize    , "Resize"     + Chr(9) + "Ctrl+R")
        
            MenuTitle("Filters")
            MenuItem(#Menu_Item_Pixelate, "Pixelate")
            MenuTitle("Effects")
            MenuItem(#Eff_pencil   , "Pencil")
            MenuItem(#Eff_artist   , "Artist")
            MenuItem(#Eff_noise    , "Lithograph")
            MenuItem(#Eff_scratch  , "Horizontal Scratch")
            MenuItem(#Eff_glowie   , "Glowie")
            MenuItem(#Eff_phantom  , "Computer Phantom")
            MenuItem(#Eff_Demon    , "Demon")
            MenuItem(#Eff_Faded    , "Faded")
            MenuItem(#Eff_spacy    , "Spacy")
            MenuItem(#Eff_blush    , "Blush")
            MenuBar()
            ;PIXELATE1(image, value)
          ;  MenuItem(#Eff_spectrum , "Pixelate")
      ...
      Select WaitWindowEvent()
         ...
         Case #PB_Event_Menu
            Select EventMenu()
               ...
               Case #Menu_Item_Flip       : FLIP()           : UPDATE_CANVAS_IMAGE()
               Case #Menu_Item_Mirror     : MIRROR()         : UPDATE_CANVAS_IMAGE()
               Case #Menu_Item_Gray       : GRAY()           : UPDATE_CANVAS_IMAGE()
               Case #Menu_Item_Pixelate   : PIXELATE1(#Image, 3) : UPDATE_CANVAS_IMAGE()
               Case #Menu_Item_Colorise   : COLORISE()       : UPDATE_CANVAS_IMAGE()
...
Procedure MIRROR()   ; Ctrl+M
 ...
 Procedure FLIP()  
   Protected d,x,y,yp,Xmax,Ymax,Ylim  
   If IsImage(#Image)
      StartDrawing(ImageOutput(#Image))        
;           Xmax = OutputWidth() - 1
;          Xlim = OutputWidth() / 2 - 1
...
Procedure PIXELATE1(image, value)
